...
const DashHeader = () => {
    ...
    if(isAdmin|| isEmployee){if (TRIPS_REGEX.test(pathname)) {
        newTripButton = (
            <button
    ...
    if (isAdmin){if (USERS_REGEX.test(pathname)) {
        newUserButton = (
            <button
                className="icon-button"
                title="New User"
   ...
   if(isAdmin|| isEmployee){ if (!TRIPS_REGEX.test(pathname) && pathname.includes('/dash')) {
        tripsButton = (
            <button
                className="icon-button"
                title="Trips"
    ...
    if (pathname !== '/dash') {
        goHomeButton = (
            <button
                className="icon-button dash-header__home"
                title="Home"
